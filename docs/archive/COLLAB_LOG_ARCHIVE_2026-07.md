# COLLAB_LOG Archive — entries up to 2026-07-07

Older entries moved out of `COLLAB_LOG.md` on 2026-07-09 to keep it fast to read.
Nothing here was deleted — this is the verbatim history. Critical do-not-undo decisions
are summarized in the main `COLLAB_LOG.md`.
